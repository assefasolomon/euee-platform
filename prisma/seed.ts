...
import { seedMathG12Unit1Lesson3GeometricSum } from "./content/math-g12-u1-l3";
...
async function main() {
  ...
  await seedMathG12Unit1Lesson3GeometricSum(prisma);
  ...
  console.log("All content modules seeded successfully. (Unit 2 removed, awaiting rebuild against real textbook structure.)");
}
